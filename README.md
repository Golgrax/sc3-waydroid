...
![image-1](assets/img/README/1.png)

![image-2](assets/img/README/2.png)

![image-3](assets/img/README/3.png)
...
# Install something
sudo venv/bin/python3 main.py install {gapps, magisk, libndk, libhoudini, nodataperm, smartdock, microg, mitm, asd}
...
# Install asd.apk
sudo venv/bin/python3 main.py install asd
...
## Install asd.apk, Roblox exploit
